...
- `Not started`
- `Guidance provided`[Rhino Lapidary · Products · Shopify.url](../../../../AppData/Local/Temp/Rhino%20Lapidary%20%C2%B7%20Products%20%C2%B7%20Shopify.url)
- `In progress`
- `Blocked`
...
| 3 | A-033 | Verify product template purchase architecture | P0 | M | Ready for verification | Resolve the current purchase-path risk: the default product template lacks normal buy controls. |
