...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-005 | Remove or ignore IDE project files from version control | P1 | S | Guidance provided | Finishes repository hygiene before more generated QA artifacts accumulate. |
| 2 | A-006 | Add a `.shopifyignore` policy | P1 | S | Guidance provided | Prevents repo-only docs, tests, and local config from being uploaded to Shopify. |
| 3 | A-012 | Add a no-placeholder-content check | P1 | S | Guidance provided | Blocks stock Trade copy from surviving into launch/release workflows. |
| 4 | A-015 | Create a PR checklist for Shopify theme work | P1 | S | Guidance provided | Makes review expectations explicit now that CI and release standards exist. |
| 5 | A-014 | Create a changelog or release notes template | P2 | S | Guidance provided | Gives non-developers a readable release summary format before visual/content changes accelerate. |
...
| A-005 | Remove or ignore IDE project files from version control | P1 | S | Guidance provided |  |  |
| A-006 | Add a `.shopifyignore` policy | P1 | S | Guidance provided |  |  |
...
| A-012 | Add a no-placeholder-content check | P1 | S | Guidance provided |  |  |
| A-013 | Create a repository release checklist | P0 | S | Complete |  |  |
| A-014 | Create a changelog or release notes template | P2 | S | Guidance provided |  |  |
| A-015 | Create a PR checklist for Shopify theme work | P1 | S | Guidance provided |  |  |
