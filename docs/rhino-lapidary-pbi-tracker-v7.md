...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-022 | Verify domain, DNS, and HTTPS launch requirements | P0 | M | Guidance provided | Launch cannot proceed until canonical domain, redirects, and TLS are proven. |
| 2 | A-023 | Create redirect and URL migration architecture | P1 | M | Guidance provided | The redirect map depends on the canonical domain decision. |
| 3 | A-021 | Create analytics migration and verification plan | P1 | M | Guidance provided | Pixel policy is complete, so event ownership and migration can now be planned. |
| 4 | A-047 | Define structured data and SEO architecture | P1 | M | Guidance provided | Canonicals, redirects, product fields, and organization identity need one SEO model. |
| 5 | A-053 | Define backup and rollback procedures | P0 | M | Guidance provided | Domain, redirect, analytics, SEO, theme, and admin changes need a rollback process. |
