...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-054 | Create a production launch readiness gate | P0 | M | Guidance provided | Combines existing automated checks into one explicit launch-blocking command. |
| 2 | A-060 | Audit generated and local-only files before first production push | P1 | S | Guidance provided | Verifies repository and Shopify upload cleanliness before the first serious launch push. |
| 3 | A-007 | Define `settings_data.json` ownership and safety rules | P0 | M | Guidance provided | Protects theme-editor state now that customization entrypoints and tests exist. |
| 4 | A-008 | Establish development, preview, and production theme workflow | P0 | M | Guidance provided | Formalizes the environment workflow before Epic B begins making visible storefront changes. |
| 5 | A-033 | Verify product template purchase architecture | P0 | M | Guidance provided | Closes the original purchase-path risk with a stricter template/config/purchase validator. |
...
| A-038 | Create navigation architecture decision record | P1 | M | Complete |  |  |
| A-039 | Define locale and internationalization strategy | P2 | M | Not started |  |  |
| A-040 | Create design token inventory and governance | P1 | M | Complete |  |  |
| A-041 | Define CSS architecture for Rhino customizations | P1 | M | Complete |  |  |
| A-042 | Audit duplicate and dead CSS/JS assets | P2 | M | Complete |  |  |
| A-043 | Audit stock icon and illustration assets | P2 | S | Complete |  |  |
| A-044 | Define JavaScript architecture and event contracts | P1 | M | Complete |  |  |
| A-045 | Create a Custom Liquid and app embed guardrail | P1 | S | Complete |  |  |
| A-046 | Create media asset source-of-truth rules | P1 | M | Complete |  |  |
...
| A-057 | Create a known stock Trade remnants ledger | P1 | M | Complete |  |  |
| A-058 | Create a Rhino custom section/block strategy | P1 | M | Complete |  |  |
| A-059 | Define hardcoded string and locale strategy | P2 | M | Complete |  |  |
...
|---|---|---|---|
| 2026-07-30 | A-042 | Complete | User confirmed CSS/JS dead-asset audit is finished. |
| 2026-07-30 | A-043 | Complete | User confirmed stock icon/illustration audit is finished. |
| 2026-07-30 | A-046 | Complete | User confirmed media asset source-of-truth rules are finished. |
| 2026-07-30 | A-057 | Complete | User confirmed stock Trade remnants ledger is finished. |
| 2026-07-30 | A-059 | Complete | User confirmed hardcoded string and locale strategy is finished. |
| 2026-07-30 | A-054 | Guidance provided | Production launch readiness gate supplied. |
| 2026-07-30 | A-060 | Guidance provided | Generated/local-only file audit supplied. |
| 2026-07-30 | A-007 | Guidance provided | settings_data ownership and validator supplied. |
| 2026-07-30 | A-008 | Guidance provided | theme environment workflow and validator supplied. |
| 2026-07-30 | A-033 | Guidance provided | product purchase architecture verification supplied. |
| 2026-07-30 | A-038 | Complete | User confirmed navigation architecture/route tests are finished. |
| 2026-07-30 | A-040 | Complete | User confirmed design token governance is finished. |
| 2026-07-30 | A-041 | Complete | User confirmed CSS architecture boundary is finished. |
| 2026-07-30 | A-044 | Complete | User confirmed JavaScript architecture/event contracts are finished. |
| 2026-07-30 | A-058 | Complete | User confirmed Rhino custom section/block strategy is finished. |
| 2026-07-30 | A-042 | Guidance provided | CSS/JS dead-asset audit script supplied. |
| 2026-07-30 | A-043 | Guidance provided | Stock icon/illustration inventory and validator supplied. |
| 2026-07-30 | A-046 | Guidance provided | Media source-of-truth rules and media manifest validator supplied. |
| 2026-07-30 | A-057 | Guidance provided | Stock Trade remnants ledger and validator supplied. |
| 2026-07-30 | A-059 | Guidance provided | Hardcoded string and locale strategy validator supplied. |
