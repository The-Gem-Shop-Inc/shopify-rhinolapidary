...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-024 | Define admin dependency register | P0 | M | Guidance provided | Converts admin-only assumptions into a versioned, machine-checkable register. |
| 2 | A-030 | Define fixture data for tests and previews | P1 | M | Guidance provided | Gives smoke, accessibility, product, and collection tests stable fixtures. |
| 3 | A-051 | Establish product data quality gates | P0 | M | Guidance provided | Automates validation before product CSV/admin data can silently break launch pages. |
| 4 | A-034 | Create product template architecture decision record | P1 | M | Guidance provided | Defines template classes and adds repository checks for required template blocks. |
| 5 | A-035 | Create collection and filtering architecture decision record | P1 | M | Guidance provided | Defines customer-facing filters as data, then validates filter/source dependencies. |
