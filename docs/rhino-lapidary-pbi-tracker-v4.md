...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-025 | Define browser and device support baseline | P1 | S | Guidance provided | Establishes the QA matrix used by accessibility, performance, and future visual testing. |
| 2 | A-026 | Establish accessibility baseline | P0 | M | Guidance provided | Prevents branding and custom components from creating accessibility debt. |
| 3 | A-027 | Establish performance budget | P0 | M | Guidance provided | Sets limits before images, video, scripts, apps, and custom sections expand the storefront. |
| 4 | A-013 | Create a repository release checklist | P0 | S | Guidance provided | Can now reference concrete browser, accessibility, performance, validation, and rollback standards. |
| 5 | A-001 | Document the local development workflow | P0 | S | Guidance provided | Consolidates the completed environment, validation, release, and safety rules into the repository entry point. |
...
|---|---|:---:|:---:|---|:---:|---|
| A-001 | Document the local development workflow | P0 | S | Guidance provided |  |  |
...
| A-025 | Define browser and device support baseline | P1 | S | Guidance provided |  |  |
| A-026 | Establish accessibility baseline | P0 | M | Guidance provided |  |  |
| A-027 | Establish performance budget | P0 | M | Guidance provided |  |  |
