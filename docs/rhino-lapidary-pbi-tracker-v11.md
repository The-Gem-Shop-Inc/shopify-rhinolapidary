...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-042 | Audit duplicate and dead CSS/JS assets | P2 | M | Guidance provided | Now that Rhino CSS/JS entrypoints exist, detect unused inherited/custom assets before they accumulate. |
| 2 | A-043 | Audit stock icon and illustration assets | P2 | S | Guidance provided | Prevents launch with leftover generic Trade imagery or unowned SVG/icon assets. |
| 3 | A-046 | Create media asset source-of-truth rules | P1 | M | Guidance provided | Product presentation depends on clean ownership of images, videos, manuals, alt text, and file naming. |
| 4 | A-057 | Create a known stock Trade remnants ledger | P1 | M | Guidance provided | Converts known inherited Trade leftovers into an explicit, testable cleanup ledger. |
| 5 | A-059 | Define hardcoded string and locale strategy | P2 | M | Guidance provided | Keeps future copy and locale work from becoming hardcoded Liquid/text drift. |
