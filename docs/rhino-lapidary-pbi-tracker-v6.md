...
|---:|---|---|:---:|:---:|---|---|
| 1 | A-018 | Document app dependency and app embed policy | P0 | M | Guidance provided | Establishes the approval model before apps, embeds, or Shopify-native integrations are added. |
| 2 | A-019 | Audit all app block surfaces in the theme | P1 | M | Guidance provided | Maps where app blocks can enter the storefront and which surfaces are high-risk. |
| 3 | A-045 | Create a Custom Liquid and app embed guardrail | P1 | S | Guidance provided | Prevents theme-editor code from bypassing repository review. |
| 4 | A-020 | Create a third-party script and pixel register | P0 | M | Guidance provided | Gives analytics, marketing, and pixels a single owner and deduplication point. |
| 5 | A-048 | Create security and privacy review checklist | P1 | M | Guidance provided | Ties apps, pixels, forms, customer events, consent, and removal plans into one review process. |
...
| A-018 | Document app dependency and app embed policy | P0 | M | Guidance provided |  |  |
| A-019 | Audit all app block surfaces in the theme | P1 | M | Guidance provided |  |  |
| A-020 | Create a third-party script and pixel register | P0 | M | Guidance provided |  |  |
...
| A-045 | Create a Custom Liquid and app embed guardrail | P1 | S | Guidance provided |  |  |
...
| A-048 | Create security and privacy review checklist | P1 | M | Guidance provided |  |  |
